...
import { useRetrievalPractice } from "../hooks/learningHooks/useRetrievalPractice";
...
import StatsPanel from "./learningComponents/StatsPanel";
...
import QuickTips from "./learningComponents/QuickTips";
...
const LearningTechniques = () => {
  ...
  const retrievalHook = useRetrievalPractice();
        ...
        <div className="max-w-6xl mx-auto space-y-8">
          ...
          <div className="text-center space-y-4" data-aos="fade-down">
            ...
            <p className="text-lg italic text-gray-600 max-w-2xl mx-auto">
              Focus your mind, enhance your learning, and grow at your own pace.
              Use proven techniques with calming sounds to create your perfect
              study environment.
            </p>
          </div>
          ...
          <div className="space-y-6">
            ...
            {activeTechnique === "pomodoro" ? (
              ...
              <RetrievalPractice retrievalHook={retrievalHook} />
            )}
            {activeTechnique === "pomodoro" && (
              <SessionTargetSelector pomodoroHook={pomodoroHook} />
            )}
